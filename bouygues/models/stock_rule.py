...
from odoo import api, models, _, SUPERUSER_ID, fields
...
class StockRule(models.Model):
    ...
    def _update_purchase_order_line(self, product_id, product_qty, product_uom, company_id, values, line):
        ...
        if values['group_id'] and values['group_id'].sale_id:
            res['sale_order_ids'] = line.sale_order_ids
            if res['sale_order_ids']:
                res['sale_order_ids'] |= values['group_id'].sale_id
            else:
                res['sale_order_ids'] |= values['group_id'].sale_id
        return res
    ...
    def _prepare_purchase_order_line(self, product_id, product_qty, product_uom, company_id, values, po):
        ...
        res['sale_order_ids'] = values['group_id'].sale_id if values['group_id'] and values['group_id'].sale_id else None
        return res
    ...
    def _run_buy(self, procurements):
        ...
        for domain, procurements_rules in procurements_by_po_domain.items():
            ...
            for procurement in procurements:
                ...
                if po_line and not procurement.values.get('is_mto'):
